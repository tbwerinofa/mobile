  ...
  return (
    <View style={recipeDetailStyles.container}>
      <ScrollView>
        ...
        {projectDetail.ResidentialUnits === 0 ? (
          <View style={recipeDetailStyles.emptyState}>
            <Ionicons name="info-outline" size={64} color={COLORS.textLight} />
            <Text style={recipeDetailStyles.emptyTitle}>No request found</Text>
          </View>
        ) : (
